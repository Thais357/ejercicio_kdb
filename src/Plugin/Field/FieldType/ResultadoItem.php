...
/**
 * Class ResultadoItem
 * @package Drupal\ejercicio_kdb\Plugin\FieldType
 * @FieldType(
 *   id= "resultado_item",
 *   label = @Translation("Resultado"),
 *   default_formatter = "resultado_default",
 *   default_widget = "resultado_default"
 * )
 */
class ResultadoItem extends FieldItemBase
{
  ...
  public static function propertyDefinitions(FieldStorageDefinitionInterface $field_definition)
  {
    $properties['name'] = DataDefinition::create('string')
      ->setLabel('Resultado');
    return $properties;
    $properties['resultado'] = DataDefinition::create('integer')
      ->setComputed(TRUE)
      ->setLabel('Resultado');
   return $properties;
  }
